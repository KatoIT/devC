...
unsigned int InvNhanCot(unsigned int w)
{
    ...
    unsigned int kq4= NhanD(byte1) ^ NhanD(byte2) ^ Nhan9(byte3)^ NhanE(byte4);
    kq = (kq1 << 24) | (kq2 << 16) | (kq3 << 8) | kq4;
    return kq;
}
...
int main()
{
	//unsigned int Key = 0xAADE12F39F579A5A49845A7797FE9146
	//K = CFD61D48 9E7C48BC 46C9F875 C1F04E1B
	// K= C281B176 3B140EF7 AB12EB27 45F1F59F
  // unsigned int w0 = 0xAADE12F3, w1 = 0x9F579A5A, w2 = 0x49845A77, w3 = 0x97FE9146;
   unsigned int w0 = 0x2B7E1516 , w1 = 0x28AED2A6, w2 = 0xABF71588, w3 = 0x09CF4F3C;
   unsigned int Key[] = {w0, w1, w2, w3};
	//input  M = BC3034B5D3677672E290C28DC16922FB
	//M = 18DC9095 F9149EDB 7323F20E 4E462D92
	//M = B104AADD 3AC293DF 787EFD2C F8065925
    unsigned int *state = new unsigned[4];
	//state[0] = 0xBC3034B5; state[1] = 0xD3677672; state[2] = 0xE290C28D; state[3] = 0xC16922FB;
